        ...
        <Carousel controls={false} pauseOnHover={false}>
            <Carousel.Item>
              <div className="gridRow setCol3">
                <img src={retaining_wall_allen_block_landscape} alt="retaining_wall_allen_block_landscape" className="coverWidth" />
                <img src={lawn_maintenance_square} alt="retaining_wall_allen_block_landscape" className="coverWidth" />
                <img src={softscape_square} alt="retaining_wall_allen_block_landscape" className="coverWidth" />
              </div>
            </Carousel.Item>
        </Carousel>
      </div>
