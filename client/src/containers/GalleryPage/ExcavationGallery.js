  ...
  constructor() {
    ...
    this.state = {
      imgs: [
        ...
        { src: e6, alt: alt },
        { src: e7, alt: alt },
        { src: e8, alt: alt, ratio: "width", style: { marginTop: "-60%" } },
        { src: e9, alt: alt },
        { src: e10, alt: alt },
        { src: e11, alt: alt },
        { src: e12, alt: alt, ratio: "width", style: { marginTop: "-60%" } },
        { src: e13, alt: alt },
        { src: e14, alt: alt, ratio: "width", style: { marginTop: "-60%" } },
        { src: e15, alt: alt, ratio: "width", style: { marginTop: "-60%" } },
        { src: e16, alt: alt },
        { src: e17, alt: alt },
        { src: e18, alt: alt },
        { src: e19, alt: alt }
