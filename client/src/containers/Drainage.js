          ...
          <div className="gridRow col2">
            <div className="textOverlap marginBottom centerText">
              <div className="textBlock">
                ...
                <p>There two main types of drainage; surface and subsurface drainage systems. Surface drainage collects water from the surface and redirects it elsewhere. A subsurface drainage system is installed beneath the soil surface and is typically used for landscapes, gardens and behind retaining walls.</p>
                <p>During the construction of your landscape, we pay particular attention to how water will behave in and around your new landscape so new water drainage issues are not created.</p>
              </div>
            </div>
            <div className="picUnder"><img src={drainage2} alt="" className="pic" /></div>
          </div>
        </div>
    );
  }
