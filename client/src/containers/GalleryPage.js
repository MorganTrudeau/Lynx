    ...
    return (
      <div className="galleryPage">
        <Switch>
          ...
          <Route
            path="/gallery/paving-stones"
            component={PavingStonesGallery}
          />
          <Route path="/gallery/lawn-install" component={LawnInstallGallery} />
          <Route
            path="/gallery/irrigation-lighting"
            component={IrrigationLightingGallery}
          />
          <Route path="/gallery/drainage" component={DrainageGallery} />
          <Route
            path="/gallery/lawn-maintenance"
            component={LawnMaintenanceGallery}
          />
          <Route path="/gallery/excavation" component={ExcavationGallery} />
