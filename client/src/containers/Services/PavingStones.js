          ...
          <div className="gridRow col2">
            <div className="textOverlap marginBottom centerText">
              <div className="textBlock">
                ...
                <p>There are so many different stone options, ranging in style and price. And because of this, you always have the ability to choose from numerous colours to help match any style of home.</p>
                <p>Lynx Landscaping warranties all paving stone work, and this includes a variety of finishing touches. The use of polymeric sand, which is brushed between the joints after the brickwork is completed, helps to lower the amount of maintenance, keeping weeds at bay. All areas with paving stones/brickwork installed will first be excavated. We then apply a road base material, which is then compacted with a plate tamper to ensure your surface will not settle or sink.</p>
              </div>
            </div>
