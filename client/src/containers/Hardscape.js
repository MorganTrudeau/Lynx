...
import hardscape1 from '../images/Hardscape/outdoor-living_paver-patio_wall_plantings_steps_boulders_hardscape_021.jpg';
import hardscape2 from '../images/Hardscape/hardscape_allen_block_stone_wall_yard_garden_landscaping.jpg';
    ...
    return (
        <div className="hardscape centerText">
          ...
          <div className="gridRow col2">
            <div className="picUnder"><img src={hardscape1} alt="" className="pic" /></div>
          ...
          <div className="gridRow col2">
            ...
            <div className="picUnder"><img src={hardscape2} alt="" className="pic" /></div>
          </div>
        </div>
    );
  }
